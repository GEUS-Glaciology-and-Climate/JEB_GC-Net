...
c ------------------------------------------------------- GITS
	if(st.eq.3)then 
          input1='/ice/tools/aws/temp/03.arg'
          input2='/ice/tools/aws/temp/03t.dat'
          input3='/ice/tools/aws/temp/03.dat'
	endif
c ------------------------------------------------------- NASA-U
	if(st.eq.4)then 
          input1='/ice/tools/aws/temp/04.arg'
          input2='/ice/tools/aws/temp/04t.dat'
          input3='/ice/tools/aws/temp/04.dat'
	endif
c ------------------------------------------------------- Humboldt
	if(st.eq.5)then 
          input1='/ice/tools/aws/temp/05_1999.arg'
          input2='/ice/tools/aws/temp/05t_1999.dat'
          input3='/ice/tools/aws/temp/05_1999.dat'
	endif
c ------------------------------------------------------- TUNU-N
	if(st.eq.7)then 
	  input1='/ice/tools/aws/temp/07.arg'
	  input2='/ice/tools/aws/temp/07t.dat'
	  input3='/ice/tools/aws/temp/07.dat'
	endif
c ------------------------------------------------------- DYE-2
	if(st.eq.8)then 
          input1='/ice/tools/aws/temp/08.arg'
          input2='/ice/tools/aws/temp/08t.dat'
          input3='/ice/tools/aws/temp/08.dat'
	endif
c ------------------------------------------------------- NASA E
	if(st.eq.12)then 
	  input1='/ice/tools/aws/temp/12.arg'
	  input2='/ice/tools/aws/temp/12t.dat'  
	  input3='/ice/tools/aws/temp/12.dat'
	endif
c ------------------------------------------------------- NGRIP
	if(st.eq.14)then 
	  input1='/ice/tools/aws/temp/14.arg'
	  input2='/ice/tools/aws/temp/14t.dat'  
	  input3='/ice/tools/aws/temp/14.dat'
	endif
