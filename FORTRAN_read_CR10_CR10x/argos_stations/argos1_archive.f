...
c ---------------------------------------------------------	
	...
	out1='/ice/tools/aws/temp/04.argx'
	out2='/ice/tools/aws/temp/05.argx'
	out3='/ice/tools/aws/temp/07.argx'
	out4='/ice/tools/aws/temp/12.argx'
	out5='/ice/tools/aws/temp/14.argx'
	out6='/ice/tools/aws/temp/03.argx'
c ---------------------------------------------------------
	open(1,file=in1)
	open(2,file=out1)
	open(3,file=out2)
